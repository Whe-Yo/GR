...
from sampling_forkmeans import Inference
...
def get_args_parser():
    ...
    parser.add_argument('--checkpoint_path', type=str, default='./Training/Trinity/_Transformer_20240206_145653/Checkpoints/trained_model.pth')
    parser.add_argument('--checkpoint_config', type=str, default='./Training/Trinity/_Transformer_20240206_145653/config.json5')
