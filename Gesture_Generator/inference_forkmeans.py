...
from Gesture_Lexicon.lexicon_KMeans import predict_lexeme
...
def get_args_parser():
    ...
    parser.add_argument('--name_file', type=str, default='1-1')
    parser.add_argument('--random_cutsample_sec', type=str, default=None) # None : whole time
    parser.add_argument('--checkpoint_path', type=str, default='./Training/Trinity/_RNN_20240202_185508/Checkpoints/trained_model.pth')
    parser.add_argument('--checkpoint_config', type=str, default='./Training/Trinity/_RNN_20240202_185508/config.json5')
    parser.add_argument('--lxc_checkpoint_path', type=str,
                        default='../Gesture_Lexicon/Training/Trinity/_Transformer_20240206_145653/Checkpoints/trained_model.pth')
    parser.add_argument('--lxc_checkpoint_config', type=str, default='../Gesture_Lexicon/Training/Trinity/_Transformer_20240206_145653/config.json5')
...
class Inference:
    def __init__(self,
        ...
        self.uniform_len = self.config_data_preprocessing['fps'] * self.config_data_preprocessing['onset_bounds'][1]
    ...
    def sample(self, dir_data: str, name_file: str, dir_save: str = "./"):
        ...
        infer_res = infer_train_forkmeans(batch, self.device, self.net_vqvae, uniform_len, num_blocks, self.config["network"]["name"])
